...
$form = new \tool_lpimportreferentiel\form\import($url->out(false), array('persistent' => null, 'context' => $context));

if ($data = $form->get_data()) {
    require_sesskey();

    $xml = $form->get_file_content('importfile');
    $importer = new \tool_lpimportreferentiel\framework_importer($xml);

...
namespace tool_lpimportreferentiel\form;
...
class import extends moodleform {
    ...
    public function definition() {
        ...
        $mform = $this->_form;
        $element = $mform->createElement('filepicker', 'importfile', get_string('importfile', 'tool_lpimportreferentiel'));
        ...
        $this->add_action_buttons(false, get_string('import', 'tool_lpimportreferentiel'));
    }
